...
export const testimonials = [
  {
    quote:
      "Travid took our platform from fragile to enterprise-grade in under 10 weeks. The engineering rigor was unmatched.",
    name: "Aisha Patel",
    title: "VP Engineering, Northwind Logistics",
  },
  {
    quote:
      "They balanced product speed with infrastructure depth. We shipped faster and reduced cloud costs by 32%.",
    name: "Mark Feldman",
    title: "CTO, Finora Labs",
  },
  {
    quote:
      "We finally have a backend we can trust. The team felt like an extension of our leadership group.",
    name: "Lena Ortiz",
    title: "Head of Product, Lucent Health",
  },
];
...
export const techStack = [
  ...
  { name: "Terraform", file: "/tech/terraform.svg" },
];
